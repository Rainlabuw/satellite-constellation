...
def update_multitask(k, ax, earth_image, task_to_hex_map, assignments, A_eqiv):
    ax.clear()
...
def plot_multitask_scenario(hexagon_to_task_mapping, assignments, A_eqiv, save_loc, show=True):
    ...
    ani  = FuncAnimation(fig, update_multitask, fargs=(ax, earth_image, task_to_hex_mapping, assignments, A_eqiv), 
                         frames=T, interval=1000, blit=False)
