...
def solve_w_haald(benefits, init_assignment, lambda_, L, graphs=None, parallel=True, verbose=False, eps=0.01):
    """
    Sequentially solves the problem using the HAAL-D algorithm.

    When parallel = True, runs all auction in parallel by constraining each assignment to the current assignment,
...
def solve_w_haald_track_iters(benefits, init_assignment, lambda_, L, graphs=None, verbose=False, eps=0.01, parallel=True):
    """
